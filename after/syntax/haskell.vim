...
" MY MODIFICATION! SEARCH FOR "_CHANGE_" FOR MODIFICATIONS
...
"if exists("hs_highlight_debug") " _CHANGE_ (commented line)
  " Debugging functions from the standard prelude.
"  syn keyword hsDebug undefined error trace " _CHANGE_ (commented line)
"endif " _CHANGE_ (commented line)

" _CHANGE_ (added line below)
